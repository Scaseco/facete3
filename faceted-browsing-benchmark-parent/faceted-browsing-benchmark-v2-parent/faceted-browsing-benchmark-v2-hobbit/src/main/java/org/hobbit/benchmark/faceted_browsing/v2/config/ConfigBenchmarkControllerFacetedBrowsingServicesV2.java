 ...
 */
@Configuration
public class ConfigBenchmarkControllerFacetedBrowsingServicesV2 {
    private static final Logger logger = LoggerFactory.getLogger(ConfigBenchmarkControllerFacetedBrowsingServicesV2.class);
...
//	}
    ...
    public ServiceBuilder<?> dataGeneratorServiceFactory(@Value("${" + Constants.BENCHMARK_PARAMETERS_MODEL_KEY + ":{}}") String paramModel) {
        ...
        String imageName = FacetedBrowsingBenchmarkV2Constants.config.getDataGeneratorImageName();
    ...
    public ServiceBuilder<?> taskGeneratorServiceFactory() {
        ...
        //String imageName = "git.project-hobbit.eu:4567/gkatsibras/faceteddatagenerator/image";
        String imageName = FacetedBrowsingBenchmarkV2Constants.config.getTaskGeneratorImageName();
...
//        .setImageName("git.project-hobbit.eu:4567/defaulthobbituser/defaultevaluationstorage:1.0.0")
	...
	String imageName = FacetedBrowsingBenchmarkV2Constants.config.getEvaluationModuleImageName();;
