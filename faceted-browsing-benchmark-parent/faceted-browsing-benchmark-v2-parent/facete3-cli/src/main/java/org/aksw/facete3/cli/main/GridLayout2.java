...
/*
/* A copy of Laterna's GridLayout class that distributes sizes evenly if space does not suffice
/* Laterna's version greatly favors large components, making it highly
/* likely for smaller components to shrink to 0 size
 * 
 * Claus Stadler 2019-01-04
 */
...
public class GridLayout2 implements LayoutManager {
     ...
     */
    public GridLayout2(int numberOfColumns) {
     ...
     * @return Itself
     */
    public GridLayout2 setHorizontalSpacing(int horizontalSpacing) {
     ...
     * @return Itself
     */
    public GridLayout2 setVerticalSpacing(int verticalSpacing) {
     ...
     * @return Itself
     */
    public GridLayout2 setTopMarginSize(int topMarginSize) {
        if(topMarginSize < 0) {
     ...
     * @return Itself
     */
    public GridLayout2 setBottomMarginSize(int bottomMarginSize) {
     ...
     * @return Itself
     */
    public GridLayout2 setLeftMarginSize(int leftMarginSize) {
        if(leftMarginSize < 0) {
     ...
     * @return Itself
     */
    public GridLayout2 setRightMarginSize(int rightMarginSize) {
