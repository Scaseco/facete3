...
public class TestResourceAccess {
	...
	public void testResourceAccessTasks() throws IOException {
    	try(InputStream in = HobbitBenchmarkUtils.openBz2InputStream("hobbit-sensor-stream-150k-events-tasks.ttl.bz2")) {
	...
	public void testResourceAccessData() throws IOException {
    	try(InputStream in = HobbitBenchmarkUtils.openBz2InputStream("hobbit-sensor-stream-150k-events-data.trig.bz2")) {
    		Assert.assertNotNull(in);
    	}
	}
