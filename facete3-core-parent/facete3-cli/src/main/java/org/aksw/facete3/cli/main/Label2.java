...
public class Label2 extends AbstractComponent<Label2> {
    ...
    protected BiFunction<Integer, String[], List<String>> lineWrapper;
    ...
    public Label2(String text) {
        ...
        this.lineWrapper = TerminalTextUtils::getWordWrappedText;
        setText(text);
    }
    
    public void setLineWrapper(BiFunction<Integer, String[], List<String>> lineWrapper) {
    ...
    protected TerminalSize getBounds(String[] lines, TerminalSize currentBounds) {
        ...
        if(labelWidth == null || labelWidth == 0) {
            ...
            List<String> wordWrapped = lineWrapper.apply(labelWidth, lines);
     ...
     * @return Itself
     */
    public synchronized Label2 setForegroundColor(TextColor foregroundColor) {
     ...
     * @return Itself
     */
    public synchronized Label2 setBackgroundColor(TextColor backgroundColor) {
     ...
     * @return Itself
     */
    public synchronized Label2 setLabelWidth(Integer labelWidth) {
    ...
    protected ComponentRenderer<Label2> createDefaultRenderer() {
        return new ComponentRenderer<Label2>() {
            @Override
            public TerminalSize getPreferredSize(Label2 Label) {
                return labelSize;
            }

            @Override
            public void drawComponent(TextGUIGraphics graphics, Label2 component) {
                ...
                if(component.getLabelWidth() == null) {
                	...
                	linesToDraw = lineWrapper.apply(graphics.getSize().getColumns(), component.lines).toArray(new String[0]);
                }
