 ...
 */
public class ReturnModelBuilderTest {

    public ReturnModelBuilderTest() {
    }
    ...
    public static Model build(String experimentUri,
                              ...
                              ArrayList<QueryIDTest> queriesWithTimeout){
        ...
        // TODO adding default stuff
        // TODO change default stuff
        String expInfo = String.format("%s hobbit:involvesSystemInstance %s ; \n"
                +"\t hobbit:involvesBenchmark %s ; \n"
                +"\t hobbit:wasCarriedOut %s> ; \n"
                +"\t hobbit:startTime \" \"^^xsd:dateTime ; \n"
                +"\t hobbit:endTime \" \"^^xsd:dateTime ; \n"
        ...
        if (queriesWithTimeout.isEmpty()) {
            ...
            for (QueryIDTest x : queriesWithTimeout) {
        ...
        for (Map.Entry<Integer, ArrayList<QueryIDTest>> entry : chokePointsTable.entrySet()) {
            for (QueryIDTest x : entry.getValue()){
