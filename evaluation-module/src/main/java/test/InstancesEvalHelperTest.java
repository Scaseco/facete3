 ...
 */
public class InstancesEvalHelperTest {
    ...
    InstancesEvalHelperTest(Integer true_pos, Integer false_neg, Integer false_pos, Integer query_time){
    ...
    public boolean equals(Object other) {
        if (other instanceof InstancesEvalHelperTest) {
            InstancesEvalHelperTest otherPair = (InstancesEvalHelperTest) other;
            return
    ...
    public void add(InstancesEvalHelperTest other){
