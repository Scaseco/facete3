...
public class TestObservableGraph {
    public static void main(String[] args) {
        ...
        graph.add(Triple.create(RDF.Nodes.type, RDFS.Nodes.label, NodeFactory.createLiteralString("type")));

        graph.add(Triple.create(RDF.Nodes.first, RDFS.Nodes.label, NodeFactory.createLiteralString("Hello")));
        graph.add(Triple.create(RDF.Nodes.first, RDFS.Nodes.label, NodeFactory.createLiteralString("World")));
        graph.delete(Triple.create(RDF.Nodes.first, RDFS.Nodes.label, NodeFactory.createLiteralString("World")));
        graph.delete(Triple.create(RDF.Nodes.first, RDFS.Nodes.label, NodeFactory.createLiteralString("World")));

        graph.add(Triple.create(RDF.Nodes.first, RDFS.Nodes.label, NodeFactory.createLiteralString("Cheers")));

        graph.add(Triple.create(RDF.Nodes.rest, RDFS.Nodes.label, NodeFactory.createLiteralString("Hello")));
